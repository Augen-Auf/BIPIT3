...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource" Width="874px" CellPadding="4" ForeColor="#333333" GridLines="None" style="margin-top: 13px" DataKeyNames="IdO">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Total" DataFormatString="{0:N0}" HeaderText="Total" ReadOnly="True" SortExpression="Total" />
        </Columns>
